...
define view entity ZC_BOOKING_001_1 as projection on ZR_BOOKING_001
{
  key BookingUUID,
  TravelUUID,
  ...
  /* Associations */
  _BookingStatus,
  _BookingSupplement: redirected to composition child ZC_BKSUPPL_001,
  _Carrier,
  _Connection,
  _Customer,
  _Travel: redirected to parent zc_travel_001  
}
