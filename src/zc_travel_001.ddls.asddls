...
define root view entity ZC_TRAVEL_001 
...
//                                          useForValidation: true  
    ...
    @ObjectModel.text.element: [ 'OverallStatus' ]
     @Consumption.valueHelpDefinition: [{ entity: {name: '/DMO/I_Overall_Status_VH', 
                                          ...
                                          useForValidation: true}]   
    OverallStatus,
    _OverallStatus._Text.Text as OverallStatusText: localized, //Localized para trabajar el mimso idioma del sistema
   
    LastChangedAt,
    /* Associations */
    _Agency,
    _Booking: redirected to composition child ZC_BOOKING_001_1,
    _Currency,
    _Customer,
    _OverallStatus
}
